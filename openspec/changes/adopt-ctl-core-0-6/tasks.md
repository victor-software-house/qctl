...
- [x] 1.1 Pin ctl-core `=0.6.2` in both dependency tables; proof: `Cargo.lock` resolves ctl-core 0.6.2
...
- [ ] 1.5 Close QCTL-037 when the pull request merges; proof: `qctl check` passes
